...
// THIS IS TEMPORARY - USE INCLUDE LATER INSTEAD
int temp_round(double num) {
...
void SingleShip::resetHealth(int level) {
    health = ENEMY_BASE_HEALTH + temp_round(level / ENEMY_INCREASE_HEALTH);
}
...
void MiniBoss::resetHealth(int level) {
    health = ENEMY_9_BASE_HEALTH + temp_round(level / ENEMY_BOSS_INCREASE_HEALTH);
}

void MasterBoss::resetHealth(int level) {
    health = ENEMY_10_BASE_HEALTH + temp_round(level / ENEMY_BOSS_INCREASE_HEALTH);
}
